export interface SeaechGifsResponse {
    data:       Gif[];
...
export enum SourceTLD {
    Empty = "",
    OsmeusfragmentosTumblrCOM = "osmeusfragmentos.tumblr.com",
...
export class Convert {
    public static toSeaechGifsResponse(json: string): SeaechGifsResponse {
        return cast(JSON.parse(json), r("SeaechGifsResponse"));
    }

    public static seaechGifsResponseToJson(value: SeaechGifsResponse): string {
        return JSON.stringify(uncast(value, r("SeaechGifsResponse")), null, 2);
    }
}
